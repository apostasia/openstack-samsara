...
then
  ...
  samples_dir=$BASE_DIR"/adaptation_enable/"$experiment_session_dir
    ...
    echo "[+] Ajustando Diretório das Amostras"
    samples_dir=$BASE_DIR"/adaptation_disable/"$experiment_session_dir
...
do
    ...
    do
        nova boot --flavor m2.tiny \
            --image samsara-soul-2hours \
            --nic net-id=c6407592-54d6-475d-88e6-1e8c430cee2b \
